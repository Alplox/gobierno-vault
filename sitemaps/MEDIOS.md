...
| --- | --- | --- | --- | --- | --- |
| `24horas` | 24 Horas | `www.24horas.cl/robots.txt` | — | 188.347 | 2 |
...
| `aitnews` | AIT News | `aitnews.com/sitemap_index.xml` | articleOnly (Yoast) | 79.263 | 17 |
...
| `antofagastaaldia` | Antofagasta al Día | `antofagastaaldia.cl/sitemap_index.xml` | articleOnly (Yoast) | 3.141 | 7 |
...
| `auroranoticias` | Aurora Noticias | `auroranoticias.cl/sitemap_index.xml` | articleOnly (Yoast) | 2.090 | 2 |
...
| `centralnoticia` | Central Noticia | `www.centralnoticia.cl/sitemap_index.xml` | articleOnly (Yoast) | 18.855 | 2 |
| `centralweb` | Central Web | `centralweb.cl/sitemap_index.xml` | articleOnly (Yoast) | 10.059 | 5 |
...
| `chilepaisminero` | Chile País Minero | `chilepaisminero.com/sitemap.xml` | — | 4.028 | 4 |
...
| `chocale` | Chocale | `chocale.cl/sitemap_index.xml` | articleOnly (Yoast) | 14.277 | 10 |
| `ciper` | CIPER Chile | `www.ciperchile.cl/sitemap_index.xml` | articleOnly (Yoast) | 8.446 | 18 |
| `clave9` | Clave 9 | `clave9.cl/sitemap_index.xml` | articleOnly (Yoast) | 13.119 | 10 |
...
| `desenfoque` | Desenfoque | `desenfoque.cl/sitemap_index.xml` | articleOnly (Yoast) | 6.588 | 5 |
| `df` | Diario Financiero | `www.df.cl/noticias/site/sitemap_pags.xml, www.df.cl/noticias/site/sitemap_news.xml, www.df.cl/noticias/site/list/port/sitemap_df.xml` | — | 1.536 | 2 |
...
| `diarioelcentro` | Diario El Centro | `www.diarioelcentro.cl/sitemap_index.xml` | articleOnly (Yoast) | 6.577 | 2 |
...
| `diariolongino` | Diario El Longino | `diariolongino.cl/sitemap_index.xml` | articleOnly (Yoast) | 15.405 | 6 |
...
| `dsstgo` | Colegio Alemán de Santiago | `dsstgo.cl/sitemap_index.xml` | articleOnly (Yoast) | 371 | 2 |
...
| `el_periodista` | El Periodista | `www.elperiodista.cl/sitemap_index.xml` | articleOnly (Yoast) | 85.743 | 18 |
...
| `elciudadano` | El Ciudadano | `www.elciudadano.com/sitemap_index.xml` | articleOnly (Yoast) | 305.577 | 22 |
...
| `elinformadorchile` | El Informador Chile | `www.elinformadorchile.cl/sitemap_index.xml` | articleOnly (Yoast) | 879 | 1 |
...
| `elmorrodearica` | El Morro de Arica | `elmorrodearica.cl/sitemap_index.xml` | articleOnly (Yoast) | 4.579 | 7 |
| `elmostrador` | El Mostrador | `www.elmostrador.cl/robots.txt` | — | 297 | 1 |
| `elnoticierodelhuasco` | El Noticiero del Huasco | `elnoticierodelhuasco.cl/wp-sitemap.xml` | includeRe | 26.052 | 17 |
| `elovallino` | El Ovallino | `elovallino.cl/sitemap_index.xml` | articleOnly (Yoast) | 3.351 | 3 |
| `elperiodico` | El Periódico | `elperiodico.cl/sitemap_index.xml` | articleOnly (Yoast) | 1.146 | 2 |
...
| `elrancaguino` | El Rancagüino | `elrancaguino.cl/sitemap_index.xml` | articleOnly (Yoast) | 70.495 | 16 |
...
| `holanews` | HolaNews | `holanews.com/sitemap_index.xml` | articleOnly (Yoast) | 19.000 | 1 |
...
| `la_hora` | La Hora | `lahora.cl/sitemap.xml` | includeRe | 44.856 | 3 |
...
| `lacuarta` | La Cuarta | `www.lacuarta.com/arc/outboundfeeds/sitemap-index/?outputType=xml` | — | 10.605 | 1 |
...
| `latercera` | La Tercera | `www.latercera.com/robots.txt` | — | 14.275 | 1 |
| `latribunadecolchagua` | La Tribuna de Colchagua | `latribunadecolchagua.cl/sitemap_index.xml` | articleOnly (Yoast) | 1.021 | 4 |
...
| `nuevopoder` | Nuevo Poder | `www.nuevopoder.cl/sitemap_index.xml` | articleOnly (Yoast) | 56.912 | 5 |
...
| `panoramanoticioso` | Panorama Noticioso | `panoramanoticioso.cl/sitemap_index.xml` | articleOnly (Yoast) | 2.510 | 1 |
...
| `portalfruticola` | Portal Frutícola | `www.portalfruticola.com/sitemap_index.xml` | articleOnly (Yoast) | 30.025 | 3 |
...
| `portalminero` | Portal Minero | `www.portalminero.com/sitemap.xml` | — | 33.037 | 15 |
| `portalportuario` | PortalPortuario | `portalportuario.cl/sitemap_index.xml` | articleOnly (Yoast) | 105.822 | 12 |
...
| `publimetro` | Publimetro | `www.publimetro.cl/arc/outboundfeeds/sitemap-index/?outputType=xml` | — | 274 | 1 |
| `publimicro` | Publimicro | `publimicro.cl/sitemap_index.xml` | articleOnly (Yoast) | 10.293 | 2 |
| `pucv` | Pontificia Universidad Católica de Valparaíso | `www.pucv.cl/pucv/site/sitemap_pags.xml` | — | 14.672 | 5 |
...
| `radiolasenal` | Radio La Señal | `radiolasenal.cl/sitemap_index.xml` | articleOnly (Yoast) | 2.173 | 2 |
...
| `radionuevomundo` | Radio Nuevo Mundo | `radionuevomundo.cl/sitemap_index.xml` | articleOnly (Yoast) | 14.371 | 9 |
...
| `radioudec` | Radio UdeC | `www.radioudec.cl/sitemap_index.xml` | articleOnly (Yoast) | 11.035 | 7 |
...
| `redimin` | REDIMIN | `www.redimin.cl/sitemap_index.xml` | articleOnly (Yoast) | 48.720 | 8 |
...
| `sabes` | Sabes.cl | `sabes.cl/sitemap.xml` | includeRe | 18.345 | 2 |
| `saintgeorge` | Saint George's College | `saintgeorge.cl/sitemap_index.xml` | articleOnly (Yoast) | 1 | 1 |
| `saladeprensa` | Sala de Prensa | `www.saladeprensa.cl/sitemap_index.xml` | articleOnly (Yoast) | 3.506 | 4 |
...
| `theclinic` | The Clinic | `www.theclinic.cl/sitemap_index.xml` | articleOnly (Yoast) | 192.709 | 19 |
...
| `usm` | USM | `usm.cl/sitemap_index.xml` | — | 6.170 | 6 |
...
| `zonazero` | Zona Zero | `www.zonazero.cl/sitemap.xml` | — | 1.094 | 1 |
