...
| --- | --- | --- | --- | --- | --- |
| `24horas` | 24 Horas | `www.24horas.cl/robots.txt` | — | 189.083 | 2 |
...
| `aitnews` | AIT News | `aitnews.com/sitemap_index.xml` | articleOnly (Yoast) | 79.280 | 17 |
...
| `ansalatina` | ANSA Latina | `www.ansalatina.com/robots.txt, www.ansalatina.com/americalatina/sitemaps/sito_sitemap_index.xml` | — | 398 | 1 |
| `antofacity` | Antofacity | `antofacity.com/sitemap_index.xml` | articleOnly (Yoast) | 3.337 | 16 |
| `antofagastaaldia` | Antofagasta al Día | `antofagastaaldia.cl/sitemap_index.xml` | articleOnly (Yoast) | 3.156 | 7 |
...
| `auroranoticias` | Aurora Noticias | `auroranoticias.cl/sitemap_index.xml` | articleOnly (Yoast) | 2.120 | 2 |
...
| `capa9` | Capa9 | `capa9.net/sitemap.xml` | — | 37.309 | 18 |
...
| `centralnoticia` | Central Noticia | `www.centralnoticia.cl/sitemap_index.xml` | articleOnly (Yoast) | 19.067 | 2 |
...
| `chilepaisminero` | Chile País Minero | `chilepaisminero.com/sitemap.xml` | — | 4.059 | 4 |
...
| `chocale` | Chocale | `chocale.cl/sitemap_index.xml` | articleOnly (Yoast) | 14.316 | 10 |
...
| `cnnchile` | CNN Chile | `www.cnnchile.com/robots.txt` | — | 227.761 | 16 |
...
| `cooperativa` | Cooperativa | `www.cooperativa.cl/robots.txt` | — | 2.781 | 1 |
...
| `desenfoque` | Desenfoque | `desenfoque.cl/sitemap_index.xml` | articleOnly (Yoast) | 6.622 | 5 |
| `df` | Diario Financiero | `www.df.cl/noticias/site/sitemap_pags.xml, www.df.cl/noticias/site/sitemap_news.xml, www.df.cl/noticias/site/list/port/sitemap_df.xml` | — | 1.984 | 2 |
| `diarioangamos` | Diario Angamos | `diarioangamos.com/sitemap.xml` | includeRe | 18.004 | 6 |
| `diarioantofagasta` | Diario Antofagasta | `diarioantofagasta.cl/sitemap_index.xml` | articleOnly (Yoast) | 27.325 | 16 |
...
| `diariodepuertomontt` | Diario de Puerto Montt | `diariodepuertomontt.cl/sitemap.xml` | — | 22.211 | 10 |
...
| `diarioelcentro` | Diario El Centro | `www.diarioelcentro.cl/sitemap_index.xml` | articleOnly (Yoast) | 6.617 | 2 |
| `diarioeldia` | Diario El Día | `www.diarioeldia.cl/sitemap.xml` | — | 3.461 | 15 |
...
| `diariolagoranco` | Diario Lago Ranco | `diariolagoranco.cl/sitemap.xml` | — | 51.196 | 13 |
...
| `diariolongino` | Diario El Longino | `diariolongino.cl/sitemap_index.xml` | articleOnly (Yoast) | 15.483 | 6 |
...
| `diarioregionalaysen` | Diario Regional Aysén | `diarioregionalaysen.cl/sitemap.xml` | — | 25.298 | 8 |
...
| `elciudadano` | El Ciudadano | `www.elciudadano.com/sitemap_index.xml` | articleOnly (Yoast) | 305.787 | 22 |
...
| `eldiariodelaaraucania` | El Diario de La Araucanía | `eldiariodelaaraucania.cl/sitemap_index.xml` | articleOnly (Yoast) | 7.822 | 3 |
| `eldinamo` | El Dínamo | `www.eldinamo.cl/robots.txt` | — | 252.114 | 17 |
| `electromineria` | Electrominería | `electromineria.cl/sitemap_index.xml` | articleOnly (Yoast) | 6.926 | 5 |
...
| `elinformadorchile` | El Informador Chile | `www.elinformadorchile.cl/sitemap_index.xml` | articleOnly (Yoast) | 1.001 | 1 |
...
| `elmorrodearica` | El Morro de Arica | `elmorrodearica.cl/sitemap_index.xml` | articleOnly (Yoast) | 4.595 | 7 |
...
| `elperiodico` | El Periódico | `elperiodico.cl/sitemap_index.xml` | articleOnly (Yoast) | 1.166 | 2 |
| `elperiodicodelaenergia` | El Periódico de la Energía | `elperiodicodelaenergia.com/sitemaps/sitemap.xml` | — | 91.668 | 13 |
...
| `elrancaguino` | El Rancagüino | `elrancaguino.cl/sitemap_index.xml` | articleOnly (Yoast) | 70.622 | 16 |
...
| `elsoldeiquique` | El Sol de Iquique | `elsoldeiquique.cl/sitemap_index.xml` | articleOnly (Yoast) | 29.367 | 16 |
...
| `emol` | Emol | `www.emol.com/robots.txt` | includeRe | 1.113.582 | 27 |
| `enfoquedigital` | Enfoque Digital | `enfoquedigital.cl/sitemap_index.xml` | articleOnly (Yoast) | 950 | 3 |
| `enfoquedigitalohiggins` | Enfoque Digital O'Higgins | `vi.cl/sitemap_index.xml` | articleOnly (Yoast) | 20.374 | 3 |
| `enlalinea` | En La Línea | `enlalinea.cl/sitemap_index.xml` | articleOnly (Yoast) | 6.227 | 4 |
...
| `estapasando` | Está Pasando | `estapasando.cl/sitemap_index.xml` | articleOnly (Yoast) | 51.891 | 6 |
...
| `france24` | France 24 | `www.france24.com/sitemaps/es/index.xml` | includeRe | 236.319 | 10 |
...
| `holanews` | HolaNews | `holanews.com/sitemap_index.xml` | articleOnly (Yoast) | 19.901 | 1 |
| `horadenoticias` | Hora de Noticias | `horadenoticias.cl/sitemap_index.xml` | articleOnly (Yoast) | 18.096 | 8 |
...
| `infogate` | Infogate | `www.infogate.cl/sitemap.xml` | includeRe | 10.798 | 1 |
...
| `ipsnoticias` | IPS Agencia de Noticias | `ipsnoticias.net/wp-sitemap.xml` | articleOnly (Yoast) | 109.978 | 33 |
| `iquiquetv` | Iquique TV | `iquiquetv.cl/sitemap.xml` | includeRe | 8.813 | 8 |
| `itvpatagonia` | ITV Patagonia | `itvpatagonia.com/sitemap_index.xml` | articleOnly (Yoast) | 14.912 | 4 |
| `junji` | JUNJI | `junji.cl/sitemap_index.xml` | articleOnly (Yoast) | 4.723 | 11 |
| `la_hora` | La Hora | `lahora.cl/sitemap.xml` | includeRe | 45.189 | 3 |
...
| `lacuarta` | La Cuarta | `www.lacuarta.com/arc/outboundfeeds/sitemap-index/?outputType=xml` | — | 11.234 | 1 |
...
| `laprensaaustral` | La Prensa Austral | `laprensaaustral.cl/wp-sitemap.xml` | includeRe | 67.531 | 7 |
| `laprensadiariolaprensa` | La Prensa | `new.diariolaprensa.cl/sitemap_index.xml` | articleOnly (Yoast) | 18.596 | 6 |
| `laserenaonline` | La Serena Online | `laserenaonline.cl/sitemap.xml` | includeRe | 39.327 | 11 |
...
| `latercera` | La Tercera | `www.latercera.com/robots.txt` | — | 15.335 | 1 |
...
| `margamargatv` | Margamarga TV | `margamargatv.cl/sitemap_index.xml` | articleOnly (Yoast) | 8.286 | 5 |
...
| `mercopress` | MercoPress | `es.mercopress.com/sitemap.xml` | includeRe | 46.668 | 14 |
...
| `musicaynoticias` | Música y Noticias | `musicaynoticias.cl/sitemap_index.xml` | articleOnly (Yoast) | 12.195 | 3 |
| `nacimentano` | Nacimentano | `nacimentano.cl/sitemap_index.xml` | articleOnly (Yoast) | 102 | 2 |
...
| `nostalgica` | Nostálgica | `nostalgica.cl/sitemap_index.xml` | articleOnly (Yoast) | 29.953 | 3 |
...
| `paislobo` | País Lobo | `paislobo.cl/sitemap.xml` | includeRe | 51.350 | 8 |
| `panoramanoticioso` | Panorama Noticioso | `panoramanoticioso.cl/sitemap_index.xml` | articleOnly (Yoast) | 2.552 | 1 |
...
| `portalfruticola` | Portal Frutícola | `www.portalfruticola.com/sitemap_index.xml` | articleOnly (Yoast) | 30.066 | 3 |
...
| `portalminero` | Portal Minero | `www.portalminero.com/sitemap.xml` | — | 33.106 | 15 |
| `portalportuario` | PortalPortuario | `portalportuario.cl/sitemap_index.xml` | articleOnly (Yoast) | 105.930 | 12 |
...
| `publimetro` | Publimetro | `www.publimetro.cl/arc/outboundfeeds/sitemap-index/?outputType=xml` | — | 349 | 1 |
| `publimicro` | Publimicro | `publimicro.cl/sitemap_index.xml` | articleOnly (Yoast) | 10.293 | 2 |
| `pucv` | Pontificia Universidad Católica de Valparaíso | `www.pucv.cl/pucv/site/sitemap_pags.xml` | — | 14.706 | 5 |
...
| `radioimagina` | Radio Imagina | `radioimagina.cl/sitemap_index.xml` | articleOnly (Yoast) | 28.776 | 14 |
| `radiointeramericana` | Radio Interamericana | `radiointeramericana.cl/wp-sitemap.xml` | includeRe | 1.546 | 1 |
| `radiolasenal` | Radio La Señal | `radiolasenal.cl/sitemap_index.xml` | articleOnly (Yoast) | 2.827 | 2 |
...
| `radionuevomundo` | Radio Nuevo Mundo | `radionuevomundo.cl/sitemap_index.xml` | articleOnly (Yoast) | 14.404 | 9 |
| `radiopaulina` | Radio Paulina | `radiopaulina.cl/sitemap.xml` | includeRe | 9.591 | 2 |
...
| `redaccion` | Redacción | `redaccion.cl/sitemap_index.xml` | articleOnly (Yoast) | 244 | 1 |
| `redimin` | REDIMIN | `www.redimin.cl/sitemap_index.xml` | articleOnly (Yoast) | 48.932 | 8 |
...
| `reporteagricola` | Reporte Agrícola | `www.reporteagricola.cl/sitemap.xml` | — | 5.500 | 3 |
| `resonanciadiario` | Resonancia Diario | `www.resonanciadiario.cl/sitemap_index.xml` | articleOnly (Yoast) | 1.144 | 3 |
| `reuters` | Reuters | `www.reuters.com/robots.txt` | includeRe | 14.109 | 4 |
| `rewildingchile` | Fundación Rewilding Chile | `rewildingchile.org/sitemap_index.xml` | articleOnly (Yoast) | 310 | 6 |
| `rfi` | RFI Español | `www.rfi.fr/sitemaps/es/index.xml` | includeRe | 396.606 | 18 |
...
| `sabes` | Sabes.cl | `sabes.cl/sitemap.xml` | includeRe | 18.561 | 2 |
| `saintgeorge` | Saint George's College | `saintgeorge.cl/sitemap_index.xml` | articleOnly (Yoast) | 1 | 1 |
| `saladeprensa` | Sala de Prensa | `www.saladeprensa.cl/sitemap_index.xml` | articleOnly (Yoast) | 3.521 | 4 |
| `sancarlosonline` | San Carlos On Line | `sancarlosonline.cl/sitemap.xml` | includeRe | 42.569 | 16 |
...
| `terram` | Fundación Terram | `www.terram.cl/sitemap.xml` | includeRe | 30.874 | 25 |
| `theclinic` | The Clinic | `www.theclinic.cl/sitemap_index.xml` | articleOnly (Yoast) | 192.827 | 19 |
...
| `uteusachnoticias` | UTE USACH Noticias | `corporacionuteusach-noticias.cl/sitemap_index.xml` | articleOnly (Yoast) | 5.867 | 7 |
...
| `vlnradio` | VLN Radio | `www.vlnradio.cl/sitemap.xml` | includeRe | 12.033 | 2 |
...
| `zonazero` | Zona Zero | `www.zonazero.cl/sitemap.xml` | — | 1.141 | 1 |
