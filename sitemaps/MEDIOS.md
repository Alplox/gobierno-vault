...
| --- | --- | --- | --- | --- | --- |
| `24horas` | 24 Horas | `www.24horas.cl/robots.txt` | — | 187.721 | 2 |
...
| `canal9` | Canal 9 | `www.canal9.cl/sitemap, www.canal9.cl/sitemap-news` | — | 24.249 | 2 |
...
| `centralnoticia` | Central Noticia | `www.centralnoticia.cl/sitemap_index.xml` | articleOnly (Yoast) | 18.447 | 2 |
...
| `df` | Diario Financiero | `www.df.cl/noticias/site/sitemap_pags.xml, www.df.cl/noticias/site/sitemap_news.xml, www.df.cl/noticias/site/list/port/sitemap_df.xml` | — | 863 | 2 |
| `diarioangamos` | Diario Angamos | `diarioangamos.com/sitemap.xml` | includeRe | 18.004 | 6 |
| `diarioantofagasta` | Diario Antofagasta | `diarioantofagasta.cl/sitemap_index.xml` | articleOnly (Yoast) | 27.280 | 16 |
...
| `diariodepuertomontt` | Diario de Puerto Montt | `diariodepuertomontt.cl/sitemap.xml` | — | 22.137 | 10 |
...
| `diarioeldia` | Diario El Día | `www.diarioeldia.cl/sitemap.xml` | — | 3.165 | 15 |
...
| `diariolagoranco` | Diario Lago Ranco | `diariolagoranco.cl/sitemap.xml` | — | 51.099 | 13 |
...
| `diarioregionalaysen` | Diario Regional Aysén | `diarioregionalaysen.cl/sitemap.xml` | — | 25.201 | 8 |
...
| `eldinamo` | El Dínamo | `www.eldinamo.cl/robots.txt` | — | 251.861 | 17 |
...
| `elsoldeiquique` | El Sol de Iquique | `elsoldeiquique.cl/sitemap_index.xml` | articleOnly (Yoast) | 29.310 | 16 |
...
| `emol` | Emol | `www.emol.com/robots.txt` | includeRe | 1.112.978 | 27 |
...
| `ex_ante` | Ex-Ante | `www.ex-ante.cl/sitemap_index.xml` | articleOnly (Yoast) | 18.173 | 7 |
...
| `fastcheck` | Fast Check CL | `www.fastcheck.cl/sitemap.xml` | includeRe | 6.158 | 7 |
...
| `france24` | France 24 | `www.france24.com/sitemaps/es/index.xml` | includeRe | 235.634 | 10 |
...
| `holanews` | HolaNews | `holanews.com/sitemap_index.xml` | articleOnly (Yoast) | 18.758 | 1 |
...
| `infogate` | Infogate | `www.infogate.cl/sitemap.xml` | includeRe | 10.667 | 1 |
...
| `itvpatagonia` | ITV Patagonia | `itvpatagonia.com/sitemap_index.xml` | articleOnly (Yoast) | 14.846 | 4 |
| `junji` | JUNJI | `junji.cl/sitemap_index.xml` | articleOnly (Yoast) | 4.723 | 11 |
| `la_hora` | La Hora | `lahora.cl/sitemap.xml` | includeRe | 44.808 | 3 |
...
| `meganoticias` | Meganoticias | `www.meganoticias.cl/robots.txt` | includeRe | 434.508 | 16 |
...
| `nubleonline` | Ñuble Online | `nubleonline.cl/sitemap_index.xml` | articleOnly (Yoast) | 2.745 | 2 |
...
| `publimetro` | Publimetro | `www.publimetro.cl/arc/outboundfeeds/sitemap-index/?outputType=xml` | — | 256 | 1 |
| `publimicro` | Publimicro | `publimicro.cl/sitemap_index.xml` | articleOnly (Yoast) | 10.293 | 2 |
| `pucv` | Pontificia Universidad Católica de Valparaíso | `www.pucv.cl/pucv/site/sitemap_pags.xml` | — | 14.632 | 5 |
...
| `radioagricultura` | Radio Agricultura | `www.radioagricultura.cl/robots.txt` | — | 299.597 | 12 |
| `radiochilena` | Radio Chilena | `radiochilena.cl/sitemap_index.xml` | articleOnly (Yoast) | — | — |
| `radioimagina` | Radio Imagina | `radioimagina.cl/sitemap_index.xml` | articleOnly (Yoast) | 28.739 | 14 |
...
| `redaccion` | Redacción | `redaccion.cl/sitemap_index.xml` | articleOnly (Yoast) | 226 | 1 |
...
| `reporteagricola` | Reporte Agrícola | `www.reporteagricola.cl/sitemap.xml` | — | 5.410 | 3 |
...
| `rfi` | RFI Español | `www.rfi.fr/sitemaps/es/index.xml` | includeRe | 395.809 | 18 |
...
| `sabes` | Sabes.cl | `sabes.cl/sitemap.xml` | includeRe | 18.316 | 2 |
...
| `terram` | Fundación Terram | `www.terram.cl/sitemap.xml` | includeRe | 30.838 | 25 |
...
| `ucsc` | UCSC | `ucsc.cl/sitemap_index.xml` | — | 20.618 | 18 |
...
| `usm` | USM | `usm.cl/sitemap_index.xml` | — | 6.167 | 6 |
...
| `vlnradio` | VLN Radio | `www.vlnradio.cl/sitemap.xml` | includeRe | 11.680 | 2 |
