...
- `validate` parsea los 5 YAML al inicio y su detector de mojibake cubre doble-encoding C2/C3, controles C1 (`â€”`), U+FFFD, cirílico, Latin Ext-A/B. Reporta 3 ejemplos. Desde 24-ago-2026 también escanea `TAREAS/**/*.md` y rechaza BOM UTF-8 inicial. Si falso positivo por nombre legítimo, ajustar `MOJIBAKE_RE`.
