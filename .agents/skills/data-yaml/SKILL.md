...
- `sources/<medio-YYYY-MM-DD-slug>.md`: `{ tipo (=prensa por defecto), medio, titulo, autor, fecha, url, notas? }`. URLs siempre completas (ver `event-rules` regla 10). Ej: `src/content/sources/24horas-2026-07-20-estado-catastrofe.md`.
